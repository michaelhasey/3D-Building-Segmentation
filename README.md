...
### Intro
This project provides a robust pipeline for the autonomous classification and segmentation of individual buildings extracted from large 3d urban models. 

### Pipeline Overview
The pipeline can be broken down into 3 components; the
